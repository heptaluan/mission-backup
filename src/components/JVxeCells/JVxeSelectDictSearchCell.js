...
export const DictSearchInputCell = {
  ...
  render() {
    return (
      <a-select showSearch allowClear value={this.innerSelectValue} filterOption={this.filterOption} style="width: 100%" {...this.cellProps} onSearch={this.handleSearch} onChange={this.handleChange} scopedSlots={this.scopedSlots}>
