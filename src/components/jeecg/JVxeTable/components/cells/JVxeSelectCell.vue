<template>
  <a-select ref="select" :value="innerValue" allowClear :filterOption="handleSelectFilterOption" v-bind="selectProps" style="width: 100%" @blur="handleBlur" @change="handleChangeCommon" @search="handleSearchSelect">
