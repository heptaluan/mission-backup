<template>
  <div>
    ...
    <a-upload v-show="!hasFile" name="file" :data="{ isup: 1 }" :multiple="false" :action="originColumn.action" :headers="uploadHeaders" :showUploadList="false" v-bind="cellProps" @change="handleChangeUpload">
