        ...
        <div :id="`${caseId}tbody`" class="tbody" :style="tbodyStyle">
          ...
          <draggable :value="rows" handle=".td-ds-icons" @start="handleDragMoveStart" @end="handleDragMoveEnd">
            ...
            <template v-for="(row, rowIndex) in rows">
              ...
              <div
                v-if="rowIndex >= parseInt(`${(scrollTop - rowHeight) / rowHeight}`) && parseInt(`${scrollTop / rowHeight}`) + 9 > rowIndex"
                  ...
                  <template v-for="(id, i) in [`${col.key}${row.id}`]">
                    ...
                    <label :key="i" v-if="col.type === formTypes.input || col.type === formTypes.inputNumber">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        <input
                          ...
                          "
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click="handleEditRow(row, col)">{{ inputValues[rowIndex][col.key] }}</span>
                      </a-tooltip>
                    </label>
                    <!-- checkbox -->
                    <template v-else-if="col.type === formTypes.checkbox">
                      <a-checkbox :key="i" :id="id" v-bind="buildProps(row, col)" :checked="checkboxValues[id]" @change="e => handleChangeCheckboxCommon(e, row, col)" />
                    </template>
                    <!-- select -->
                    <template v-else-if="col.type === formTypes.select">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        <a-select
                          ...
                          allowClear
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click.stop="handleEditRow(row, col)">{{ getSelectTranslateText(selectValues[id], row, col) }}</span>
                      </a-tooltip>
                    </template>
                    ...
                    <template v-else-if="col.type === formTypes.sel_depart">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        ...
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click="handleEditRow(row, col)">{{ departCompValues[id] }}</span>
                      </a-tooltip>
                    </template>
                    ...
                    <template v-else-if="col.type === formTypes.sel_user">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        ...
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click="handleEditRow(row, col)">{{ userCompValues[id] }}</span>
                      </a-tooltip>
                    </template>
                    ...
                    <template v-else-if="col.type === formTypes.date || col.type === formTypes.datetime">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        ...
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click="handleEditRow(row, col)">{{ jdateValues[id] }}</span>
                      </a-tooltip>
                    </template>
                    <!-- input_pop -->
                    <template v-else-if="col.type === formTypes.input_pop">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        ...
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click="handleEditRow(row, col)">{{ jInputPopValues[id] }}</span>
                      </a-tooltip>
                    </template>
                    <!-- upload -->
                    <div v-else-if="col.type === formTypes.upload" :key="i">
                      ...
                      <div :hidden="uploadValues[id] != null">
                        <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                          <a-upload name="file" :data="{ isup: 1 }" :multiple="false" :action="col.action" :headers="uploadGetHeaders(row, col)" :showUploadList="false" v-bind="buildProps(row, col)" @change="v => handleChangeUpload(v, id, row, col)">
                    ...
                    <template v-else-if="col.type === formTypes.popup">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        ...
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click="handleEditRow(row, col)">{{ getPopupValue(id) }}</span>
                      </a-tooltip>
                    </template>
                    ...
                    <div v-else-if="col.type === formTypes.file" :key="i">
                      ...
                      <div :hidden="uploadValues[id] != null">
                        <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                          <a-upload name="file" :data="{ isup: 1 }" :multiple="false" :action="getUploadAction(col.action)" :headers="uploadGetHeaders(row, col)" :showUploadList="false" v-bind="buildProps(row, col)" @change="v => handleChangeUpload(v, id, row, col)">
                    ...
                    <template v-else-if="col.type === formTypes.radio">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        <a-radio-group :id="id" :key="i" v-bind="buildProps(row, col)" :value="radioValues[id]" @change="e => handleRadioChange(e.target.value, id, row, col)">
                    ...
                    <template v-else-if="col.type === formTypes.list_multi">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        <a-select
                          ...
                          allowClear
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click="handleEditRow(row, col)">{{ getSelectTranslateText(multiSelectValues[id], row, col) }} </span>
                      </a-tooltip>
                    </template>
                    <!-- select多选 -end -->
                    ...
                    <template v-else-if="col.type === formTypes.sel_search">
                      <a-tooltip v-bind="buildTooltipProps(row, col, id)">
                        <a-select
                          ...
                          allowClear
                        />
                        <span v-else class="j-td-span no-edit" :class="{ disabled: buildProps(row, col).disabled }" @click="handleEditRow(row, col)">{{ getSelectTranslateText(searchSelectValues[id], row, col) }}</span>
                      </a-tooltip>
                    </template>
                    <!-- select搜索 -end -->
          ...
          >
            <div v-if="dragSort" class="td td-ds" :style="style.tdLeft"></div>
            ...
            <template v-for="col in columns">
              <div :key="col.key" class="td" v-show="col.type !== formTypes.hidden" :style="buildTdStyle(col)">
                <span v-show="col.type === formTypes.inputNumber" style="padding: 0 5px">{{ statisticsColumns[col.key] }}</span>
              </div>
            </template>
          </div>
        </div>
