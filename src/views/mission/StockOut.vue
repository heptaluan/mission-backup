  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          <a-col :md="8" :sm="12">
            <a-form-item label="创建" :labelCol="{span: 5}" :wrapperCol="{span: 18, offset: 1}">
    ...
    <div class="table-operator" style="margin: 5px 0 10px 2px">
      <a-button @click="handleStockOut" type="primary" icon="download" v-has="'stockOut'">耗材出库</a-button>
      <!--      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">-->
      <!--        <a-button type="primary" icon="import">导入</a-button>-->
      <!--      </a-upload>-->
      <a-button type="primary" icon="download" @click="handleExportXls('出库管理')">导出</a-button>
    </div>
    <!-- table区域-begin -->
    <a-table
      ref="table"
