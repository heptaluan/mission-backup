<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('项目合作单位关联表')">导出</a-button>
    ...
    <project-company-modal ref="modalForm" @ok="modalFormOk"></project-company-modal>
  </a-card>
</template>
...
<script>
  ...
  import ProjectCompanyModal from './modules/ProjectCompanyModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/mission/projectCompany/list",
          delete: "/mission/projectCompany/delete",
