<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('耗材入库管理')">导出</a-button>
    ...
    <material-putin-modal ref="modalForm" @ok="modalFormOk"></material-putin-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'batchNo',text:'批次',dictCode:''})
