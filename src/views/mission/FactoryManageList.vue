<template>
  <a-card :bordered="false">
    ...
    <factory-manage-modal ref="modalForm" @ok="modalFormOk"></factory-manage-modal>
  </a-card>
</template>
...
export default {
  ...
  methods: {
    ...
    getSuperFieldList() {
      let fieldList = []
      fieldList.push({ type: 'string', value: 'factoryCode', text: '供应商编码', dictCode: '' })
      fieldList.push({ type: 'string', value: 'name', text: '供应商名称', dictCode: '' })
      fieldList.push({ type: 'string', value: 'contactId', text: '供应商联系人', dictCode: '' })
      fieldList.push({ type: 'string', value: 'adress', text: '供应商地址', dictCode: '' })
      fieldList.push({ type: 'string', value: 'factoryType', text: '供应商类别', dictCode: '' })
