        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="年龄" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="age">
              <a-input-number style="width:100%;" v-model="model.age" placeholder="请输入年龄" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="手机号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="phoneNumber">
              <a-input v-model="model.phoneNumber" placeholder="请输入手机号" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="身份证号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="identityNumber">
              <a-input v-model="model.identityNumber" placeholder="请输入身份证号" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        edit: 'multiomics/medicalCase/edit'
      }
    }
  },
  computed: {
