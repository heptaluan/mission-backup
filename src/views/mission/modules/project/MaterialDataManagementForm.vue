        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="文件名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="fileName">
              <a-input v-model="model.materialCode" placeholder="请输入文件名称"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="文件类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="fileType">
              <a-input v-model="model.materialName" placeholder="请输入文件类型"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="上传时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="uploadTime">
              <a-input v-model="model.materialModel" placeholder="请输入上传时间"></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
...
export default {
  name: 'MaterialDataManagementForm',
  components: {},
  props: {
    //表单禁用
    disabled: {
