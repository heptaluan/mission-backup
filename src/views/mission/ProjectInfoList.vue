  ...
  methods: {
    ...
    getSuperFieldList() {
      ...
      fieldList.push({
        ...
        text: '项目组',
        dictCode: 'project_group,group_name,id',
      })
      fieldList.push({
        type: 'string',
        value: 'projectCode',
      ...
      fieldList.push({
        type: 'Text',
        value: 'followingInclusionStandard',
        text: '项目纳入标准',
        dictCode: '',
      })
      fieldList.push({
        type: 'Text',
        value: 'excludeStandard',
        text: '项目排除标准',
        dictCode: '',
      })
      fieldList.push({
        type: 'string',
        value: 'sampleDispositon',
        text: '样本去向',
        dictCode: '',
      })
