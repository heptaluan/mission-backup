        ...
        <a-row :gutter="10">
          <a-col :md="10" :sm="12">
            <a-form-item label="用户账号" style="margin-left:8px">
              <a-input placeholder="请输入账号" v-model="queryParam.realname"></a-input>
            </a-form-item>
          </a-col>
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item>
                <a href="javascript:;" @click="handleChangePassword(record.username)">重设密码</a>
              </a-menu-item>
...
export default {
  ...
  methods: {
    ...
    loadData(arg) {
      ...
      params.realname = params.realname ? '*' + params.realname + '*' : undefined
    ...
    open(record) {
      ...
      // this.currentDeptCode = record.orgCode
      // this.currentDeptTitle = record.title
