  ...
  >
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <!--机构分配-->
        <a-form-model-item label="机构分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled">
          <j-select-depart
        ...
        <a-form-model-item label="负责机构" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-multi-select-tag
            :disabled="disableSubmit"
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        phone: [{ required: true, message: '手机号码不能为空！' }, { validator: this.validatePhone }],
