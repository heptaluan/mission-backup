  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="职务" :labelCol="labelCol" :wrapperCol="wrapperCol" v-if="false">
        ...
        <!--部门分配-->
        <a-form-model-item label="部门分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled" v-if="false">
          <j-select-depart v-model="model.selecteddeparts" :multi="true" @back="backDepartInfo" :backDepart="true"></j-select-depart>
        </a-form-model-item>

        <!--租户分配-->
        <a-form-model-item label="租户分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled" v-if="false">
          <j-multi-select-tag
            :disabled="disableSubmit"
        ...
        <a-form-model-item label="负责部门" :labelCol="labelCol" :wrapperCol="wrapperCol"  v-if="false">
          <j-multi-select-tag
            :disabled="disableSubmit"
        ...
        <a-form-model-item label="工作流引擎" :labelCol="labelCol" :wrapperCol="wrapperCol" v-if="false">
