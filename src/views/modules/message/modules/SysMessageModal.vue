<template>
  <a-drawer :title="title" :maskClosable="true" width="650" placement="right" :closable="true" @close="close" :visible="visible" style="overflow: auto; padding-bottom: 53px">
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="消息标题">
          <a-input placeholder="请输入消息标题" v-decorator="['esTitle', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="发送内容">
          <a-input placeholder="请输入发送内容" v-decorator="['esContent', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="发送所需参数">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="发送失败原因">
    ...
    <div v-show="!disableSubmit">
      <a-button style="margin-right: 0.8rem" @confirm="handleCancel">取消</a-button>
