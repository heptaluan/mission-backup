  ...
  >
    <a-form-model :layout="layout" ref="form" :model="form" :rules="rules" class="add-distributor-modal">
      ...
      <div class="form-content">
        <a-form-model-item label="渠道商账号" prop="shortName">
          <a-input :disabled="formDisabled" placeholder="请输入渠道商账号（缩写）" v-model="form.shortName" />
        </a-form-model-item>
        <a-form-model-item label="渠道商名称" prop="accessName">
          <a-input :disabled="formDisabled" placeholder="请输入渠道商名称" v-model="form.accessName" />
        </a-form-model-item>
        <a-form-model-item label="渠道商密码" prop="loginPwd">
          <a-input :disabled="formDisabled" placeholder="请输入渠道商密码" v-model="form.loginPwd" />
        </a-form-model-item>
      </div>
      <div class="form-content">
        <a-form-model-item label="联系人名称" prop="contactName">
          <a-input :disabled="formDisabled" placeholder="请输入联系人名称" v-model="form.contactName" />
        </a-form-model-item>
      ...
      <div class="form-content">
        ...
        <a-form-model-item label="统一信用码" prop="socialCode" style="margin-left:88px;">
      ...
      <div class="form-title" v-if="formDisabled">渠道商关联医院</div>
      <div class="form-content" v-if="formDisabled">
        <a-table
          ref="table"
          size="middle"
          :scroll="{ x: true }"
