...
<div class="patient-info">
  ...
  <div class="patient-info-row b-flex">
    ...
    <div class="b-flex-1 patient-info-item">
      <label>送检科室:</label>
      <span v-html="patient.sendDepartment"></span>
    </div>
    <div class="b-flex-1 patient-info-item">
      <label>送检医师:</label>
...
export default {
  ...
  computed: {
    ...
    detectionMethod () {
      ...
      return this.$route.params.template === 'sd' ? Patient.detectionMethod : (choseProduct === 'FA' ? Patient.detectionMethodFA : Patient.detectionMethodFK)
    }
  },
  mounted () {
    this.init()
