  ...
  <a-card :bordered="false">
    ...
    <a-spin :spinning="confirmLoading">
      <div class="gen-item b-flex margin-bottom-xs">
        <label style="width: 100px">表观得分：</label>
        <div class="b-flex-1">
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit (record) {
        ...
        const { geneReportValue, geneReportAll } = this.uploadItem
        this.inputScore = geneReportValue
        this.genReportUrl = geneReportAll
      },
      handleOk () {
        if(!this.validate()) {
          return false
