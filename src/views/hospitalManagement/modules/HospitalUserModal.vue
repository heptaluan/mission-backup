...
export default {
  ...
  methods: {
    ...
    edit(record) {
      ...
      that.model = Object.assign({}, { selectedroles: this.user, selecteddeparts: '' }, record)
      //身份为上级显示负责部门，否则不显示
    ...
    handleSubmit() {
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          // }
          let obj
          this.model.orgCatalog = 4000 // hardcode channel
          if (!this.model.id) {
