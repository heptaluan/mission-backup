  ...
  <a-row :gutter='10'>
    <a-col :md='12' :sm='24'>
      <a-card :bordered='false'>
        ...
        <a-row style='margin-left: 14px'>
          <a-button @click='handleAdd(1)' type='primary'>添加医院</a-button>
    ...
    <a-col :md='12' :sm='24'>
      <a-tabs defaultActiveKey='2'>
        ...
        <!--          <HospitalRelationUserList ref='relationUser' />-->
        <!--        </a-tab-pane>-->
    ...
    <hospital-relation-modal ref='departModal' @ok='loadTree'></hospital-relation-modal>
  </a-row>
</template>
<script>
import HospitalRelationModal from './modules/HospitalRelationModal'
import HospitalRelationUserList from './modules/HospitalRelationUserList'
...
export default {
  name: 'HospitalRelationship',
  mixins: [JeecgListMixin, commonFunctionsMixin],
  components: {
    HospitalRelationModal,
    HospitalRelationUserList,
    Region
  },
  data() {
    return {
  ...
  methods: {
    ...
    loadTree() {
      ...
      that.treeData = []
      that.departTree = []
      // get all organizes with '医院' type
