...
// 查询订单所有实例
export const getProductOrderInstanceList = (id) =>
  getAction(`/tailai-multiomics/multiomics/productOrderInstance/history/${id}`)

// 查询订单进度和子订单
// export const getProductOrderInstance = id => getAction(`/tailai-multiomics/multiomics/productOrderInstance/info/${id}`)
export const getProductOrderInstance = (params) =>
  getAction(`/tailai-multiomics/multiomics/productOrderInstance/info`, params)

// 订单实例重检
export const reDetectInstance = (params) =>
  postAction('/tailai-multiomics/multiomics/productOrder/reDetectInstance', params)
