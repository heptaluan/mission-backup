...
// 渠道商列表
export const getHospitalList = (params) => getAction('mission/businessAccess/hospitalList', params)
// 全部医院列表
export const getHospitalAllList = (params) => getAction('mission/businessAccess/queryAllHospital', params)
