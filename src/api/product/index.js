...
// 全部渠道商列表
export const getDistributorAllList = params => getAction('/mission/businessAccess/searchAll', params)

// 医院列表
export const getHospitalList = params => getAction('mission/businessAccess/queryAllHospital', params)
...
// 产品和组学分析流程
export const productAnalysisStepRelation = params => getAction('multiomics/productOrder/productAnalysisStepRelation', params)
